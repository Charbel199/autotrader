...
class AbstractBotInstanceService(ABC):
    ...
    @abstractmethod
    async def add_bot_instance(self, current_user: user_model.UserToken, bot_instance: bot_instance_model.BotInstanceCreate) -> bot_instance_model.BotInstanceCreateResponse: raise NotImplementedError
    ...
    @abstractmethod
    async def get_bot_instance(self, current_user: user_model.UserToken, bot_instance_id: int) -> bot_instance_model.BotInstance: raise NotImplementedError
