...
from app.AutoTrader.data.live_data.live_data_fetcher import LiveDataFetcher
...
from app.AutoTrader.data.live_data.live_data_fetcher import get_live_fetcher
