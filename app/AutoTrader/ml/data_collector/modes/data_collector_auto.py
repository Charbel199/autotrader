from app.AutoTrader.ml.data_collector.features_generator.features_generator import get_features_generator
...
from app.AutoTrader.helper import date_helper, logger
from app.AutoTrader.ml.data_collector.candlesticks_generator.candlestick_generator import get_candlestick_generator
...
class DataCollectorAuto(object):
    def __init__(self,
        ...
        candlestick_generator_processor = get_features_generator(features_generator_provider, candlesticks)
        self.generator = get_candlestick_generator(candlestick_generator_processor_provider, candlestick_generator_processor, data_fetcher, candlesticks, symbols, timeframe)
