...
from AutoTrader.models import Order, Trade, TradesSummary
...
def get_trades_summary(
    ...
    return TradesSummary(
        ...
        AverageLossPerLoosingTrade=0,
        AveragePositionHoldTime=0,
        AveragePositionHoldTimeWin=0,
        AveragePositionHoldTimeLoss=0,
        LongestNumberOfTradesWinningStreak=0,
        LongestNumberOfTradesLosingStreak=0,
        LargestProfit=0,
        LargestLoss=0,
        Fees={},
        TotalTradesDuration=0
    )
    ...
    #     profit = (transactions[i + 1].Price - transactions[i].Price) * transactions[i+1].ExecutedQuantity
    ...
    #         'Amount': transactions[i+1].ExecutedQuantity,
